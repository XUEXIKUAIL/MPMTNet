...
class Sea_Attention(torch.nn.Module):
    ...
    def forward(self, x):  # x (B,N,C)
        ...
        xx = xx_row.add(xx_column)  # 参差结构+init
...
class EnDecoderModel(nn.Module):
    ...
    def load_pre(self, pre_model1):
        ...
        print('self_b2.sharebackboned loading')
...
if __name__ == '__main__':
     ...
     model = EnDecoderModel(n_classes=41, backbone='segb2_shareb').to(device)
     out = model(rgb, dep)
